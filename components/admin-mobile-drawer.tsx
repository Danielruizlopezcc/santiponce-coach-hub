...
export function AdminMobileDrawer({ role }: { role: AdminRole }) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" showCloseButton={false} className="w-72 bg-blue-900 p-0">
        <SheetHeader className="flex h-16 flex-row items-center border-b border-white/10 px-5 py-0 gap-0">
