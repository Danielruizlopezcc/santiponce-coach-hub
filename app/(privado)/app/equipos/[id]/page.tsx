...
export default async function PrivateEquipoDetailPage({ params }: Props) {
  ...
  return (
    <div className="relative min-h-[calc(100svh-9rem)] bg-background">
      <div className={cn(isLocked && 'pointer-events-none blur-sm grayscale')}>
      ...
      {isLocked && (
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-background/80 p-8 text-center shadow-lg">
